...
#
# How this differs from 11-mantle/gpt56:
#   - gpt56 uses --model-provider bedrock --api-format responses. The harness talks to
...
invoke() {
  ...
  # path in 11-mantle/gpt56 does not need it); remove it once the runtime is fixed.
